...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    window->DrawList->AddRectFilled(check_bb.Min + ImVec2(5, 4), check_bb.Max + ImVec2(-3, -4), ImColor(0, 0, 0));

    if (*v)
    {
        window->DrawList->AddRectFilled(check_bb.Min + ImVec2(5, 4), check_bb.Max + ImVec2(-3, -4), ImColor(80, 80, 160, 255));
    }

    window->DrawList->AddRect(check_bb.Min + ImVec2(5, 4), check_bb.Max + ImVec2(-3, -4), ImColor(80, 80, 160, 255));
...
/*{
    ...
    if (*v)
    {
        window->DrawList->AddRectFilled(check_bb.Min + ImVec2(5, 4), check_bb.Max + ImVec2(-3, -4), ImColor(209, 0, 255));
    }
...
bool ImGui::BeginCombo(const char* label, const char* preview_value, ImGuiComboFlags flags)
{
    ...
    {
        window->DrawList->AddRectFilled(frame_bb.Min + ImVec2(5, 2), ImVec2(frame_bb.Max.x, frame_bb.Max.y - 2), ImColor(0, 0, 0), style.FrameRounding, ImDrawCornerFlags_Left); //28, 28, 28
        window->DrawList->AddRect(frame_bb.Min + ImVec2(5, 2), ImVec2(frame_bb.Max.x, frame_bb.Max.y - 2), ImColor(80, 80, 160, 255), style.FrameRounding, ImDrawCornerFlags_Left);
    }
...
bool ImGui::SliderScalar(const char* label, ImGuiDataType data_type, void* v, const void* v_min, const void* v_max, const char* format, float power)
{
    ...
    window->DrawList->AddRectFilled(frame_bb.Min, grab_bb.Max + ImVec2(0, 2), ImColor(80, 80, 160), style.GrabRounding); //ImColor(rainbow, 5.f, 5.f)
